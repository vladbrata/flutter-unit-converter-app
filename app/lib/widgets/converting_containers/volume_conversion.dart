...
class VolumeConversion extends StatefulWidget {
  const VolumeConversion({Key? key, required this.clearTrigger})
    : super(key: key);

  final ValueNotifier<int> clearTrigger;

  @override
  State<VolumeConversion> createState() => _VolumeConversionState();
}
...
class _VolumeConversionState extends State<VolumeConversion> {
  ...
  void _convert() {
    ...
    double converted = ConversionUtils.convertVolume(value, fromUnit, toUnit);
    setState(() {
